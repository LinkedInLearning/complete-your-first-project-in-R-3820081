...
```{r}
#get summary metrics
dt_metrics <- metric_set(accuracy, sens, spec, precision, recall, f_meas, kap)
...
```{r}
#get summary metrics
rf_metrics <- metric_set(accuracy, sens, spec, precision, recall, f_meas, kap)
rf_metrics(test, truth = Payment.Status, estimate = test_pred_rf)
```
...
```{r}
#get summary metrics
svm_metrics <- metric_set(accuracy, sens, spec, precision, recall, f_meas, kap)
